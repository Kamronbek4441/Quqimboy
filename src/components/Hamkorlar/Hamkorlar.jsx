  ...
  return (
    ...
    >
      <div className="overlay">
        <h1 className="title">{t("partnersTitle")}</h1>
        <p className="subtitle">{t("partnersSubtitle")}</p>
        ...
        <div className="partners">
          ...
          <div className="partner-card">
            <a href="https://jamesway.com/">
              <img className="img" src={jamesway} alt="Jamesway" />
            </a>
          </div>
          <div className="partner-card">
            <a href="https://www.bigdutchman.com/ru/startovaja-stranica/">
              <img className="img" src={big} alt="Big Dutchman" />
            </a>
          </div>
          <div className="partner-card">
