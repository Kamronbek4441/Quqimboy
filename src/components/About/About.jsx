    ...
    <div class="container">
      <div class="top-section">
        ...
        <div class="text-box">
          ...
          <p>
            Bizning faoliyatimiz Namangan
            viloyati, Kosonsoy tumani, Ququmboy qishlog‘ida joylashgan bo‘lib,
            hozirgi kunda 245 gektar umumiy hududda faoliyat yuritamiz. Shundan
            35 gektar yer asosiy ishlab chiqarish maydoniga ajratilgan. Bizda
            40,000 bosh naslli ona tovuq boqiladi va har yili 800,000 bosh jo‘ja
            yetishtiriladi.
          </p>
        </div>
      </div>
      ...
      <div class="bottom-section">
        <div class="features-box">
          <h3>ROSS-308 xochning asosiy xususiyatlari:</h3>
          <ul>
            <li>✔ So'yish uchun erta tayyorgarlik.</li>
            <li>✔ Kuchli tana massasi.</li>
            <li>✔ Barqaror va juda yuqori mahsuldorlik.</li>
            <li>✔ Yengil teri va jozibali tana go'shti ko'rinishi.</li>
            <li>
              ✔ Hayotiy naslni ko'paytirish qobiliyati, normal immunitet.
            </li>
            <li>✔ Bo'yi qisqa.</li>
          </ul>
        </div>
